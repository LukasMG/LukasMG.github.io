...
function scoreboardDraw(){
    ...
    ctxText.fillText("Points: " + pacMan.points, 10, 50);
    ctxText.fillText("Life count: " + pacMan.life, 10,70);
    ctxText.fillText("High Score: " + oldHighScore, 10, 90);
}
let pacMan = {
    x: 300,
    y: 300,
    ...
    move(option){
        if (option === "N" && this.isCollidingWall === false){
            ...
            if (this.y < (window.innerHeight-30) && this.x > 15){
                this.y += 5 * this.speed/slowdown;
                this.x -= 5 * this.speed/slowdown;
            }
        }else if (option === "SW" && this.isCollidingWall === false){
            if (this.y < (window.innerHeight-30) && this.x < 595){
                this.y += 5 * this.speed/slowdown;
                this.x += 5 * this.speed/slowdown;
            }
        }
...
function update(){
    if (pacMan.points - ghostPointWorth*ghostKillCounter < peletsToCollect && pacMan.life > 0){
        ...
        if (pacMan.powerPeletState > 0){
            ...
            console.log(pacMan.powerPeletState);
        }
...
if (device === "computer"){
    ...
    ghosts = [
        ...
        new Ghost(1,565,130,"gray"),
        new Ghost(2,15,220,"pink"),
        new Ghost(3,565,340,"green")
    ];
}